...
public class loginStepDefenitions {
    ...
    //static String driverPath = "/Users/natalialyaskina/Downloads/chromedriver";
    ...
    public void user_should_be_taken_to_the_success_login_page() throws Throwable {
    ...
    public void user_should_be_shown_login_message(String message) throws Throwable {
        Alert alert = driver.switchTo().alert();
        System.out.println(((Alert) alert).getText());
